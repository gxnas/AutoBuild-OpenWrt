...
#sed -i '/uci commit system/i\uci set system.@system[0].hostname='OpenWrt-GXNAS'' openwrt/package/lean/default-settings/files/zzz-default-settings
...
#sed -i "s/OpenWrt /GXNAS build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" openwrt/package/lean/default-settings/files/zzz-default-settings
sed -i "s/OpenWrt /GXNAS build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" package/lean/default-settings/files/zzz-default-settings
